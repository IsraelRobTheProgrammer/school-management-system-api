...
import { createGradeSchema, updateGradeSchema, gradeQuerySchema } from "./grade.schema";
...
export const gradeController = {
  upsert: asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccess({ res, message: "Grade saved successfully.", data: grade, statusCode: 201 });
  }),
  ...
  getStudentReport: asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!term || !academicYear) {
      throw new AppError("term and academicYear query params are required.", 400, "MISSING_PARAMS");
    }
    ...
    sendSuccess({ res, message: "Student report fetched successfully.", data: report });
  }),
  ...
  getClassReport: asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccess({ res, message: "Class report fetched successfully.", data: report });
  }),
};
