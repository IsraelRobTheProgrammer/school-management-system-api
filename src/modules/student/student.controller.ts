...
export const studentController = {
  create: asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccess({ res, message: "Student created successfully.", data: student, statusCode: 201 });
  }),
  ...
  getAll: asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccess({ res, message: "Students fetched successfully.", data: students });
  }),
  ...
  update: asyncHandler(async (req: Request, res: Response) => {
    ...
    const student = await studentService.update(req.schoolId, req.params.id, body);
