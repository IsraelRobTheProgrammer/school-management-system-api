...
export const schoolController = {
  getProfile: asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccess({ res, message: "School profile fetched successfully.", data: school });
  }),
  ...
  updateProfile: asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccess({ res, message: "School profile updated successfully.", data: school });
  }),

  // SUPER_ADMIN: list all schools across all tenants
  getAllSchools: asyncHandler(async (req: Request, res: Response) => {
    const schools = await schoolService.getAllSchools();
    sendSuccess({ res, message: "Schools fetched successfully.", data: schools });
  }),
};
